...
import { useGetOneVolunteerQuery } from "../../Store/services/volunteer";
import { useGetUserQuery } from "../../Store/services/user";
import { useDeleteVolunteerMutation } from "../../Store/services/profile";
...
export default function VolunteerDetailPage() {
  ...
  const { data, isLoading, isError, error } = useGetOneVolunteerQuery(id);
  ...
  // console.log(isOwner, currentUser?.id, data?.user?.id)

  const handleDelete = async () => {
    const confirmDelete = window.confirm(
      "Ви точно хочете видалити це волонтерство?",
    );
          ...
          >
            ...
            <Box p={{ base: 5, md: 8 }}>
              ...
              <Text
                ...
                whiteSpace="pre-line"
              >
                {data?.main_description || "Опис відсутній"}
              </Text>
            </Box>
          </Box>
            ...
            >
              ...
              <VStack align="stretch" gap={4}>
                ...
                <Box>
                  ...
                  {isOwner && (
                    <Flex gap={3} mt={5}>
                      <Button
                        ...
                        colorScheme="green"
                        borderRadius="xl"
                        onClick={() => navigate(`/volunteers/${data.id}/edit`)}
                      >
                        {t("edit")}
                      </Button>
                  ...
                  {!data?.highlighted_active && isOwner && (
                    <Button
                      as="a"
                      href="https://www.paypal.com/donate/?hosted_button_id=Z6X429MTZU9KE"
                      target="_blank"
                      ...
                      color="blue.600"
                    >
                      <FaPaypal /> Прорекламувати через PayPal
                    </Button>
                  )}
                </Box>
              </VStack>
